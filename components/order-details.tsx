...
import { markElementAsRead } from "@/lib/actions"
import { NotificationBadge } from "@/components/notification-badge"
import { AlertCircle, ArrowRightLeft, Clock, CheckCircle2, XCircle, ArrowLeft } from "lucide-react"
...
export function OrderDetails({ order }: { order: Order }) {
  ...
  const handleMarkElementAsRead = async (
    ...
    setUnreadElements((prev) => {
      const updated = prev ? { ...prev } : { status: false, execution: false, observations: [] }
      ...
      switch (elementType) {
        ...
        case "execution":
          ...
          break
        case "observation":
          if (observationId && updated.observations) {
